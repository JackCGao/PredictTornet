...
def _suggest_config(trial, base_config: Dict) -> Dict:
    ...
    if "start_filters" in cfg:
        # Choices kept in sync with existing studies to avoid distribution mismatch.
...
def run_optuna(
    ...
    study_name: str = "tornet_optuna_startfilters_32_48",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--study-name",
        type=str,
        default="tornet_optuna_startfilters_32_48",
        help="Optuna study name for persistent tuning (default: tornet_optuna_startfilters_32_48).",
    )
    parser.add_argument(
        "--storage",
        type=str,
